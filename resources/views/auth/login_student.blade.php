            ...
            <form id="loginForm" action="{{ route('student.login.auth') }}" method="POST" class="p-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required
                                   class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-cyan-500 transition"
                ...
                <div class="text-center pt-6 border-t border-gray-200 mt-6">
                    <p class="text-gray-600">
                        Belum punya akun? 
                        <a href="{{ route('student.register.form') }}" class="font-semibold  hover:border-b-2 transition">Daftar di sini</a>
                    </p>
                </div>
            </form>
        </div>
