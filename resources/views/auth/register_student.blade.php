    ...
    <div class="container mx-auto px-4 max-w-2xl">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <form id="registrationForm" action="{{ route('student.register.store') }}" method="POST" class="p-8">
                ...
                <!-- Success Message -->
                @if (session('status'))
                <div id="successMessage" class="bg-green-50 border border-green-200 rounded-xl p-4 mb-6 animate-fade-in">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                // In real application, this would be handled by the form submission
