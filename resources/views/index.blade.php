...
@section('content')
    ...
    <section class="gradient-bg text-white py-20">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6 animate-pulse">Selamat Datang di Perpustakaan Digital</h2>
            <p class="text-lg md:text-xl mb-8 text-blue-100 max-w-2xl mx-auto leading-relaxed">
                Temukan berbagai koleksi buku menarik untuk mendukung proses belajar mengajar di sekolah kami.
            </p>
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="{{ route('books.index') }}" class="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition duration-300 transform hover:scale-105 shadow-lg">
                    <i class="fas fa-search mr-2"></i>Jelajahi Koleksi
                </a>
                <a href="{{ route('student.register.form') }}" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-600 transition duration-300 transform hover:scale-105">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center p-6 hover:bg-purple-50 rounded-lg transition duration-300">
                ...
                <div class="text-center p-6 hover:bg-blue-50 rounded-lg transition duration-300">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition duration-300">
                    <div class="text-3xl md:text-4xl font-bold text-purple-600 mb-2" id="bookCount">0</div>
                    <p class="text-gray-600 font-medium">Judul Buku</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition duration-300">
                    <div class="text-3xl md:text-4xl font-bold text-green-600 mb-2" id="studentCount">0</div>
                    <p class="text-gray-600 font-medium">Siswa Terdaftar</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition duration-300">
                    <div class="text-3xl md:text-4xl font-bold text-blue-600 mb-2" id="borrowCount">0</div>
                    <p class="text-gray-600 font-medium">Peminjaman/Bulan</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition duration-300">
                    <div class="text-3xl md:text-4xl font-bold text-orange-600 mb-2" id="categoryCount">0</div>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <a href="{{ route('books.index') }}" class="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105">
                    <i class="fas fa-book-open text-4xl mb-4"></i>
                    <h4 class="text-xl font-semibold mb-2">Lihat Katalog Buku</h4>
                    <p class="text-purple-100">Jelajahi koleksi buku kami yang lengkap</p>
                </a>
                <a href="{{ route('student.register.form') }}" class="bg-gradient-to-r from-blue-500 to-teal-500 text-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105">
                    <i class="fas fa-user-graduate text-4xl mb-4"></i>
                    <h4 class="text-xl font-semibold mb-2">Daftar sebagai Siswa</h4>
                    <p class="text-blue-100">Bergabung dan nikmati layanan perpustakaan</p>
                </a>
            </div>
        </div>
    </section>
