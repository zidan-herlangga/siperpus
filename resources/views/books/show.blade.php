        ...
        <div class="md:flex">
            <div class="md:w-2/5 bg-gradient-to-br from-green-50 to-teal-50 p-8 flex items-center justify-center">
                <div class="text-center">
                    <div class="w-32 h-40 bg-gradient-to-br from-green-500 to-teal-500 rounded-lg shadow-lg mx-auto mb-4 flex items-center justify-center">
                    ...
                    <div class="space-y-3">
                        ...
                        @endif
                        <div class="text-center">
                            <span class="inline-flex items-center px-4 py-2 bg-teal-100 text-teal-800 rounded-full text-sm font-semibold">
            ...
            <div class="md:w-3/5 p-8">
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                        ...
                        @else
                            <button disabled class="flex-1 bg-gray-400 text-white py-3 px-6 rounded-lg font-semibold cursor-not-allowed flex items-center justify-center">
            ...
            @auth('student')
                <form action="{{ route('books.borrow', $book) }}" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <button type="submit" class="w-full bg-green-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-green-700 transition duration-300">
