            ...
            <div class="mb-12">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @forelse ($currentBorrowings as $borrowing)
                        ...
                        @endphp
                        <div
                            class="book-card bg-white rounded-2xl shadow-md overflow-hidden border-l-4 {{ $isOverdue ? 'border-red-500' : 'border-green-500' }}">
                            <div class="p-6">
                                ...
                                @if ($isOverdue)
                                    <div
                                        class="mt-4 bg-red-50 text-red-700 text-xs font-semibold p-3 rounded-lg text-center">
                    ...
                    @empty
                        <div
                            class="col-span-1 md:col-span-2 lg:col-span-3 bg-gray-50 text-gray-500  p-6 rounded-2xl text-center">
                            ...
                            @forelse($returnedBorrowings as $borrowing)
                                <tr>
                                    ...
                                    <td class="p-4 text-gray-600 hidden md:table-cell">
                                        {{ \Carbon\Carbon::parse($borrowing->borrow_date)->format('d M Y') }}</td>
                                    <td class="p-4 text-gray-600 hidden md:table-cell">
                                        {{ \Carbon\Carbon::parse($borrowing->return_date)->format('d M Y') }}</td>
                                    <td class="p-4">
                                        <span
                                            class="bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 rounded-full">Dikembalikan</span>
                                    </td>
                                </tr>
                            @empty
                                <tr>
