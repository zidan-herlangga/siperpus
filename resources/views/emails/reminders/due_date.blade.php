        ...
        <tr>
            <td style="padding: 20px 0;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center"
                            style="background-color: #006739; padding: 30px; border-top-left-radius: 12px; border-top-right-radius: 12px;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #555555; line-height: 1.6;">
                                Ini adalah pengingat bahwa buku yang sedang Anda pinjam akan segera jatuh tempo. Mohon
                                persiapkan untuk mengembalikannya tepat waktu agar terhindar dari denda.
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p style="margin: 0; color: #555555;"><strong>Jatuh Tempo Besok:</strong> <span
                                                style="font-weight: bold; color: #006739;">{{ $borrowing->due_date->format('d F Y') }}</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
