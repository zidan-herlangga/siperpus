...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { font-size: 7rem; font-weight: 800; line-height: 1; margin-bottom: 0.5rem; }
        h2 { font-size: 1.5rem; margin-top: 1rem; font-weight: 600; }
        p { margin-top: 0.75rem; color: #6b7280; max-width: 420px; }
        a {
            margin-top: 2rem; display: inline-block; padding: 0.75rem 1.5rem;
        ...
        img { max-width: 300px; margin-bottom: 1.5rem; }
    </style>
</head>
